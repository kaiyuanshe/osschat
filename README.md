...
- OSS.Chat - 通往 Apache Way 的一道虹桥
    - A presentation from [ApacheCon @Home 2020](https://apachecon.com/acah2020/), talk video: [OSS.Chat - A bridge to the Apache Way in China](https://www.youtube.com/watch?v=KWS4V86heh0)
    - A presentation from [Open Source for Good 开源向善 - 2020 中国开源年会暨阿帕奇中国路演 COSCon'20 & Apache Roadshow - China](http://coscon.kaiyuanshe.cn/), talk video: [OSS.Chat - 通往 Apache Way 的一道虹桥](http://coscon.kaiyuanshe.cn/#activity/agenda?pid=135)
